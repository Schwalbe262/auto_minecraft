...
public record ActionOutcome(State state, String message, int confirmedCount, Proof proof) {
    ...
    public ActionOutcome {
        ...
        if (proof==Proof.WINE_FULL_FEED && confirmedCount!=3)
            throw new IllegalArgumentException("Full wine feed proof requires exactly three confirmed inputs");
    }
    ...
    public enum Proof { NONE, ARTISAN_CYCLE_ADVANCED, WINE_PARTIAL_FEED, CONSOLIDATION_SKIPPED_UNSENT, WINE_FULL_FEED }

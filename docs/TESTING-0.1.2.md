...
- A passive real-client recording started through the local control file, rejected an attempted one-shot start while capturing, and saved a named Korean UTF-8 JSONL journal successfully. Recording and automation were OFF afterward. This smoke test observed stationary state/clock data; it does not claim verification of a manually demonstrated interaction route.
- Installed, built and downloaded release JARs matched SHA-256 `C0348CDEC1C74FCE4F4969F7F6848FE67CDE729D4EC7912BB9077C47C9B82915`.
